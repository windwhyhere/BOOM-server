      ...
      <div class="w-full max-w-[640px] bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden relative flex flex-col min-h-[560px] transition-all duration-300">
        ...
        >
            ...
            <div class="absolute top-3 right-3 p-1 rounded-bl-2xl rounded-tr-lg hover:scale-105 transition-transform">
               {isQrMode ? (
                 <Monitor class="text-indigo-600 w-6 h-6" />
               ) : (
                 <QrCode class="text-indigo-600 w-6 h-6" />
               )}
            </div>
        ...
        {isQrMode ? (
            // --- QR Code View ---
            <div class="flex-1 flex flex-col items-center justify-center p-12 animate-fade-in text-center">
                 ...
                 >
                    {/* Simulated QR Code SVG */}
                     <svg viewBox="0 0 100 100" class="w-48 h-48 text-slate-800" fill="currentColor">
                        ...
                        {/* Fix: use 'fill-opacity' instead of 'fillOpacity' */}
                    ...
                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <div class="bg-white p-1.5 rounded-lg shadow-sm">
                           <svg viewBox="0 0 24 24" class="w-6 h-6 text-cyan-500" fill="currentColor">
                    ...
                    <div class="absolute inset-0 bg-white/95 backdrop-blur-[2px] flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform scale-95 group-hover:scale-100">
                         <div class="w-12 h-12 bg-indigo-50 rounded-full flex items-center justify-center mb-3">
                            <ScanLine class="text-indigo-600 w-6 h-6" />
                         </div>
            ...
            <>
                <div class="p-12 pb-8 flex flex-col items-center flex-1 animate-fade-in">
                    ...
                    <div class="flex items-center gap-8 mb-8">
                        ...
                        <div class="w-16 h-16 bg-[#1677ff] rounded-2xl flex items-center justify-center shadow-md">
                           <Bell class="text-white w-8 h-8" fill="currentColor" />
                        </div>

                        <ArrowRightLeft class="text-slate-300 w-6 h-6" />
                        ...
                        <div class="w-16 h-16 bg-white border border-slate-100 rounded-2xl flex items-center justify-center shadow-md relative overflow-hidden">
                           ...
                           <svg viewBox="0 0 24 24" class="w-10 h-10 text-cyan-500" fill="currentColor">
                             <path d="M21.03 5.47c-1.37-.55-2.85-.93-4.4-1.07a11.37 11.37 0 00-1.87-.16c-1.74 0-3.38.34-4.9.96-.54.22-1.06.48-1.56.77l-.02.01c-.04.03-.09.05-.13.08-.12.08-.25.16-.37.24l-.07.05c-.65.45-1.25.96-1.79 1.52-.94.97-1.7 2.1-2.24 3.34-.05.11-.09.23-.13.34-.02.05-.04.11-.06.16-.2.53-.36 1.08-.48 1.64a.8.8 0 00.32.84c.36.23.73.44 1.11.64.47.24.95.46 1.44.66.12.05.23.09.35.14.07.03.15.06.22.09.81.31 1.66.56 2.53.74.15.03.3.06.45.09.37.07.74.12 1.12.16.14 0 .28.01.42.01 1.74 0 3.38-.34 4.9-.96.54-.22 1.06-.48 1.56-.77l.02-.01c.04-.03.09-.05.13-.08.12-.08.25-.16.37-.24l.07-.05c.65-.45 1.25-.96 1.79-1.52.94-.97 1.7-2.1 2.24-3.34.05-.11.09-.23.13-.34.02-.05.04-.11.06-.16.2-.53.36-1.08.48-1.64a.8.8 0 00-.32-.84c-.36-.23-.73-.44-1.11-.64-.47-.24-.95-.46-1.44-.66-.12-.05-.23-.09-.35-.14-.07-.03-.15-.06-.22-.09a11.32 11.32 0 00-2.53-.74z" />
                           </svg>
                        </div>
                    </div>
                    ...
                    <div class="w-full space-y-2 mb-6 text-slate-500 text-sm font-medium">
                        <p>你将使用以下账号授权登录</p>
                    </div>
                    ...
                    <div class="w-full bg-slate-50 rounded-lg p-4 flex items-center justify-between mb-8 group border border-transparent hover:border-slate-200 transition-colors">
                        <div class="flex items-center gap-4">
                           ...
                           <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center border border-slate-100 overflow-hidden p-1.5">
                              <svg viewBox="0 0 24 24" class="w-full h-full text-blue-500" fill="currentColor">
                    ...
                    <div class="w-full space-y-4 mb-8">
                         ...
                         <ul class="space-y-3">
                           {/* Fix: use 'class' instead of 'className' */}
                ...
                <div class="p-6 md:px-12 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4 bg-white mt-auto w-full">
                   <div class="flex items-center gap-2 text-slate-500 text-sm cursor-pointer hover:text-slate-700">
                      <Globe size={16} />
                      <span>简体中文</span>
                      {/* Fix: SVG attributes stroke-linecap, etc. */}
                   ...
                   <div class="flex items-center gap-4 w-full md:w-auto">
                      <Button size="large" class="w-full md:w-32 rounded-lg" onClick={() => {}}>
                        拒绝
                      </Button>
                      <Button type="primary" size="large" class="w-full md:w-32 rounded-lg bg-blue-600 hover:bg-blue-500" onClick={() => onLogin()}>
                        授权
                      </Button>
                   </div>
                </div>
